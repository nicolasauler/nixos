-- Desktop Hyprland config (Lua API; stubs for lua-language-server are wired
-- via the generated ~/.config/hypr/.luarc.json)

hl.monitor({ output = "HDMI-A-1", mode = "1366x768", position = "0x0", scale = 1 })
hl.monitor({ output = "DP-1", mode = "1920x1080", position = "1366x0", scale = 1, transform = 3 })
